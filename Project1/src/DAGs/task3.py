...
data_list4 = data_list1 + data_list2 + data_list3
...
(df['tags'] == 'Военная операция на УкраинеЭкономика'), (df['tags'] == 'Мир'), (df['tags'] == 'Забота о себе'), (df['tags'] == 'Россия'), (df['tags'] == 'Путешествия'), (df['tags'] == 'Ценности'), (df['tags'] == 'Бывший СССР'), (df['tags'] == 'Интернет и СМИ'),
